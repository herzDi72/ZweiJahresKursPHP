...
class syntax_plugin_projekt extends DokuWiki_Syntax_Plugin
{
    ...
    {
        $this->Lexer->addSpecialPattern('<FIXME>', $mode, 'plugin_projekt');
//        $this->Lexer->addEntryPattern('<FIXME>', $mode, 'plugin_projekt');
    }

//    public function postConnect()
//    {
//        $this->Lexer->addExitPattern('</FIXME>', 'plugin_projekt');
//    }
